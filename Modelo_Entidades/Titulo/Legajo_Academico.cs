...
{
    partial class Legajo_Academico
    {
        Modelo_Entidades.GCIEntidades oModelo_Entidades;

        public void Alta(Modelo_Entidades.Legajo_Academico oLegajo_Academico)
        {
        ...
        public void Baja(Modelo_Entidades.Legajo_Academico oLegajo_Academico)
        {
            oModelo_Entidades = Modelo_Entidades.GCIEntidades.ObtenerInstancia();
