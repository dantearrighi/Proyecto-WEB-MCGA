...
namespace Vista_Web
{
    public partial class FrmImprimirCertificado : System.Web.UI.Page
    {
        // Declaro las variables que voy a utilizar en el formulario.
        string icie;

        // Constructor
        public FrmImprimirCertificado()
        {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Profesional/Certificado_Habilitación.rdlc";

            //object YourDataHereForTheReport;
            ReportDataSource rds = new ReportDataSource("Certificado_Prof", ObjectDataSource1);
