...
namespace Vista_Web
{
    public partial class FrmImprimirCertificado_I : System.Web.UI.Page
    {
        // Declaro las variables que voy a utilizar en el formulario.
        string icie;

        // Constructor
        public FrmImprimirCertificado_I()
        {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            icie = Request.QueryString["icie"];

            ReportViewer1.ProcessingMode = ProcessingMode.Local;

            // the ReportPath is relative to the page displaying the ReportViewer
            ReportViewer1.LocalReport.ReportPath = "Profesional/Certificado_Incumbencias.rdlc";

            //object YourDataHereForTheReport;
            ReportDataSource rds = new ReportDataSource("Certificado_Prof_I", ObjectDataSource1);
