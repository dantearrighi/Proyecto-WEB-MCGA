<%@ Page Title="Gestión de Tarea" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Tarea.aspx.cs" Inherits="Vista_Web.Tarea" %>
            ...
            <div id="Div1" runat="server" class="row">
                <div id="Div2" runat="server" class="col-lg-offset-3 col-lg-6" title="Gestión de Usuario">
                    <div class="page-header">
                        <h1>Gestión de Tarea <small>Módulo de Expedientes</small></h1>
                    </div>
                    <div>
                            ...
                            <div class="tab-pane fade active in" id="datos">
                                <div class="form-horizontal" role="form">
                                    <div class="form-group">
                                        <label for="txt_nombreapellido" class="col-sm-4 control-label">Descripción:</label>
                                        <div class="col-sm-8">
