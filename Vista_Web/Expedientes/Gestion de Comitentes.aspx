<%@ Page Title="Gestión de Comitentes" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Gestion de Comitentes.aspx.cs" Inherits="Vista_Web.Comitentes" %>
                ...
                <div runat="server" class="row">
                    <div runat="server" class="col-lg-12">
                        <div class="page-header" title="Gestión de Usuarios">
                            <h1>Gestión de Comitenes <small>Módulo de Expedientes</small></h1>
                        </div>
                    </div>
                    <div id="Div4" runat="server" class="col-lg-4">
                        <div runat="server" class="form-group">
                            <label runat="server" for="exampleInputEmail1">Comitente</label>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Eliminar comitente</h4>
                        </div>
                        <div class="modal-body">
                            <p>¿Está seguro que desea eliminar al comitente?</p>
                        </div>
