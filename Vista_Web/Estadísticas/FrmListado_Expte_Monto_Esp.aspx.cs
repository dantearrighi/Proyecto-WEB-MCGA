...
namespace Vista_Web
{
    public partial class FrmListado_Expte_Monto_Esp : System.Web.UI.Page
    {
        string desde;
        string hasta; 

        // Constructor
        public FrmListado_Expte_Monto_Esp()
        {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Estadísticas/Expedientes_Por_Monto_Esp.rdlc";

            //object YourDataHereForTheReport;
            ReportDataSource rds = new ReportDataSource("Expedientes", ObjectDataSource1);
