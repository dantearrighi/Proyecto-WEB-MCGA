...
namespace Vista_Web
{
    public partial class FrmListado_Prof_Est : System.Web.UI.Page
    {
        string desde;
        string hasta; 

        // Constructor
        public FrmListado_Prof_Est()
        {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Estadísticas/Profesionales_Por_Estado.rdlc";

            //object YourDataHereForTheReport;
            ReportDataSource rds = new ReportDataSource("Estados", ObjectDataSource1);
