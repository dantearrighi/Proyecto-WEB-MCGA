<%@ Page Title="Expedientes por tarea" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="FrmListado_Expte_Obra.aspx.cs" Inherits="Vista_Web.FrmListado_Expte_Obra" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="473px" Width="971px">
                <LocalReport ReportEmbeddedResource="Vista_Web.Estadísticas.Expedientes_Por_Obra.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="Expte_Por_Obra" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="Vista_Web.App_Code.Listados_Expte_ObraTableAdapters.TareasTableAdapter">
                <SelectParameters>
