...
namespace Vista_Web
{
    public partial class FrmListado_Cuotas_Desc : System.Web.UI.Page
    {
        string desde;
        string hasta; 

        // Constructor
        public FrmListado_Cuotas_Desc()
        {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Estadísticas/Cuotas_Por_Desc.rdlc";
