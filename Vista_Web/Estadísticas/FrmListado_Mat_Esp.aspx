<%@ Page Title="Matrículas por especialidad" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="FrmListado_Mat_Esp.aspx.cs" Inherits="Vista_Web.FrmListado_Mat_Esp" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="473px" Width="971px">
                <LocalReport ReportEmbeddedResource="Vista_Web.Estadísticas.Matriculas_Por_Esp.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="Mat_Por_Esp" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="Vista_Web.App_Code.Listados_Mat_EspTableAdapters.EspecialidadesTableAdapter">
                <SelectParameters>
