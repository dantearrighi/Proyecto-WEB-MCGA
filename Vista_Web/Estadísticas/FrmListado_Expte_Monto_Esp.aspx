<%@ Page Title="Montos de expdientes por especialidad" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="FrmListado_Expte_Monto_Esp.aspx.cs" Inherits="Vista_Web.FrmListado_Expte_Monto_Esp" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="473px" Width="971px">
                <LocalReport ReportEmbeddedResource="Vista_Web.Estadísticas.Expedientes_Por_Monto_Esp.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="Exptes_Por_Monto_Esp" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="Vista_Web.App_Code.Listado_Exptes_Monto_EspTableAdapters.EspecialidadesTableAdapter">
                <SelectParameters>
                    <asp:QueryStringParameter DefaultValue="0" Name="fecha_menor" QueryStringField="desde" Type="String" />
                    <asp:QueryStringParameter DefaultValue="0" Name="fecha_mayor" QueryStringField="hasta" Type="String" />
                </SelectParameters>
