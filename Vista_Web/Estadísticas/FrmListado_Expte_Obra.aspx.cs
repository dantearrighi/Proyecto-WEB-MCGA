...
namespace Vista_Web
{
    public partial class FrmListado_Expte_Obra : System.Web.UI.Page
    {
        string desde;
        string hasta; 

        // Constructor
        public FrmListado_Expte_Obra()
        {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Estadísticas/Expedientes_Por_Obra.rdlc";
