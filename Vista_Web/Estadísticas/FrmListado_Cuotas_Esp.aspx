<%@ Page Title="Cuotas por especialidad" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="FrmListado_Cuotas_Esp.aspx.cs" Inherits="Vista_Web.FrmListado_Cuotas_Esp" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="473px" Width="971px">
                <LocalReport ReportEmbeddedResource="Vista_Web.Estadísticas.Cuotas_Por_Esp.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="Cuotas_Por_Esp" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="Vista_Web.App_Code.Listado_Cuotas_EspTableAdapters.EspecialidadesTableAdapter">
                <SelectParameters>
