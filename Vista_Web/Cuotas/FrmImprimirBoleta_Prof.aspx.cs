...
namespace Vista_Web
{
    public partial class FrmImprimirBoleta_Prof : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Cuotas/Boletas_Prof.rdlc";

            //object YourDataHereForTheReport;
            ReportDataSource rds = new ReportDataSource("Boletas_Prof", ObjectDataSource1);
