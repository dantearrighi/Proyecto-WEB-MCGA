<%@ Page Title="Impresión de recibo" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="FrmImprimirRecibo.aspx.cs" Inherits="Vista_Web.FrmImprimirRecibo" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="473px" Width="971px">
                <LocalReport ReportEmbeddedResource="Vista_Web.Contabilidad.Recibos.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="Recibos" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="Vista_Web.App_Code.RecibosTableAdapters.MovimientosTableAdapter">
                <SelectParameters>
                    <asp:QueryStringParameter DefaultValue="0" Name="comp_id" QueryStringField="comp_id" Type="Int32" />
                </SelectParameters>
