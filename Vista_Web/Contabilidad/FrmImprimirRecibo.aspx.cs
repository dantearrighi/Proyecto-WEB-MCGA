...
namespace Vista_Web
{
    public partial class FrmImprimirRecibo : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Contabilidad/Recibos.rdlc";

            //object YourDataHereForTheReport;
            ReportDataSource rds = new ReportDataSource("Recibos", ObjectDataSource1);
