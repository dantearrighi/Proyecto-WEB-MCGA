<%@ Page Title="Selección de comitente" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Seleccionar comitente.aspx.cs" Inherits="Vista_Web.SeleccionarComitente" %>
                ...
                <div runat="server" class="row">
                    <div runat="server" class="col-lg-12">
                        <div class="page-header">
                            <h1>Seleccionar comitente <small title="Selección de comitente">Módulo de Expedientes</small></h1>
                        </div>
                    </div>
                </div>
