<%@ Page Title="Impresión de titulo" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="FrmImprimirTitulo.aspx.cs" Inherits="Vista_Web.FrmImprimirTitulo" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="473px" Width="971px">
                <LocalReport ReportEmbeddedResource="Vista_Web.Titulos.Titulos.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="Titulos" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="Vista_Web.App_Code.TitulosTableAdapters.ProfesionalesTableAdapter">
                <SelectParameters>
                    <asp:QueryStringParameter DefaultValue="0" Name="dni" QueryStringField="dni" Type="Int32" />
                    <asp:QueryStringParameter DefaultValue="0" Name="id_dir" QueryStringField="id_dir" Type="Int32" />
                    <asp:QueryStringParameter DefaultValue="0" Name="icie" QueryStringField="icie" Type="String" />
                </SelectParameters>
