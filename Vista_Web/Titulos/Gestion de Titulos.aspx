<%@ Page Title="Gestión de Títulos" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Gestion de Titulos.aspx.cs" Inherits="Vista_Web.Titulos" %>
                ...
                <div runat="server" class="row">
                    <div runat="server" class="col-lg-12">
                        <div class="page-header">
                            <h1>Gestión de Títulos <small title="Gestión de Títulos">Módulo de Títulos</small></h1>
                        </div>
                    </div>
                    <div id="Div4" runat="server" class="col-lg-4">
                        <div id="Div2" runat="server" class="form-group">
                            <label id="Label1" runat="server" for="cmb_universidad">Universidad</label>
                            <asp:DropDownList ID="cmb_universidad" runat="server" class="form-control">
                            </asp:DropDownList>
                        </div>
                        <div runat="server" class="form-group">
                            <label runat="server" for="cmb_especialidades">Especialidades</label>
                            <asp:DropDownList ID="cmb_especialidades" runat="server" class="form-control">
                            </asp:DropDownList>
                        </div>
                    ...
                    <div id="Div5" runat="server" class="col-lg-8">
                        <div style="height: 300px; overflow: auto;" class="form-group">
                            <asp:GridView ID="gvTitulos" runat="server" AutoGenerateSelectButton="True" CssClass="table table-hover table-responsive table-bordered" AllowCustomPaging="False" OnSelectedIndexChanged="gvTitulos_SelectedIndexChanged" OnRowCreated="gvTitulos_RowCreated" AutoGenerateColumns="True">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>¿Está seguro que desea eliminar al título seleccionado?</p>
                        </div>
